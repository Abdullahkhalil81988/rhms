...
public class EmergencyAlert {
    ...
    /**
     * Handles an emergency situation for a patient
     * @param patient The patient experiencing the emergency
     * @param reason The reason for the emergency
     */
    public void handleEmergency(Patient patient, String reason) {
        // Log the emergency
        System.out.println("EMERGENCY ALERT: Patient " + patient.getName() + 
                          " (ID: " + patient.getUserID() + ") reports: " + reason);
        
        // Alert emergency contacts
        System.out.println("Notifying emergency contacts...");
        
        // Alert nearest hospital
        System.out.println("Contacting nearest emergency services...");
        
        // Send location data
        System.out.println("Sending patient location: " + patient.getAddress());
        
        // Alert assigned doctor if available
        System.out.println("Emergency response has been dispatched!");
    }
}