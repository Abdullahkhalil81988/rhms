...
public class UserIDManager {
     ...
     * @param nextPatientID The next patient ID to use
     * @param nextDoctorID The next doctor ID to use
     * @param nextAdminID The next admin ID to use
     */
    public static void initializeCounters(int nextPatientID, int nextDoctorID, int nextAdminID) {
        UserIDManager.nextPatientID = nextPatientID;
        UserIDManager.nextDoctorID = nextDoctorID;
        UserIDManager.nextAdminID = nextAdminID;
    }
